...
# Optional Helix Core dependencies - gracefully degrade if not available
try:
    from billing.unified_billing import HelixCoreFeature
except ImportError:
    HelixCoreFeature = None

try:
    from helix_core.adapter import HelixCoreAdapter
except ImportError:
    HelixCoreAdapter = None
...
try:
    ...
    try:
        from agents.agents_service import Kael, Lumina, Vega
    except ImportError:
    ...
    def __init__(
        ...
        class _AetherBaseAgent:
            async def process(self, query, context=None):
                try:
                    from helix_agent_swarm.agent_factory import create_agent
