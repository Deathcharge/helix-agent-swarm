...
from agents.agents_base import HelixAgent  # noqa: E402
from security.enhanced_kavach import EnhancedKavach  # noqa: E402
...
try:
    from agents.memory_root import MemoryRootAgent
except ImportError:
    ...
    async def planner(self, directive: dict[str, Any]) -> None:
        ...
        if action == "execute_cycle":
            ...
            cmd = [
                "python",
                "-c",
                "from agents import AGENTS, Shadow; import asyncio; asyncio.run(AGENTS['Shadow'].archive_collective(AGENTS))",
            ]
